...
class ZoneCollectionGeoJson(GeoJsonFeatureCollection):
    ...
    """
    swagger_types = {
        'features': 'list[ZoneCollectionGeoJsonFeatures]'
    }
    ...
    def __init__(self, features=None, *args, **kwargs):  # noqa: E501
        """ZoneCollectionGeoJson - a model defined in Swagger"""  # noqa: E501
        self._features = None
    ...
    @property
    def features(self):
        """Gets the features of this ZoneCollectionGeoJson.  # noqa: E501


        :return: The features of this ZoneCollectionGeoJson.  # noqa: E501
        :rtype: list[ZoneCollectionGeoJsonFeatures]
        """
    ...
    def features(self, features):
        ...
        :type: list[ZoneCollectionGeoJsonFeatures]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ZoneCollectionGeoJson, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ZoneCollectionGeoJson):
            return False
